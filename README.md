...
![화면 캡처 2023-07-09 154454](https://github.com/SemiKwon/Semantic_Analysis/assets/76101347/5bb706b3-90b2-4c0f-98db-fd09b1f5c7b0)

* 연결 중심성이 높은 주요 단어를 살펴보면 '없다'가 최상위 단어로, 그 외에도 '아니다'가 뒤를 이어 텍스트에 드러난 결혼의 담론이 긍정적이지 않은 것을 알 수 있음.
* '없다, 아니다' 등의 단어를 중심으로 한 네트워크를 살펴보아도 '모르다, 생각, 현실, 부자, 조건' 등의 표현을 찾아볼 수 있었음. → '없다, 아니다'와 같이 부정성을 띤 단어로 해석이 가능함.
* 결혼과 현실의 연관성에 대한 의식이 드러남.
...
* 몇몇 단어들에서는 파이계수가 0.5가 넘지 않는 것을 관찰할 수 있었음. → 따라서 완벽한 당위성을 부여하기에는 어려운 면이 있었음.
* 여기에서도 부모, 독립, 집안 등의 현실적인 단어들이 쌍으로 등장함.
* 긍정을 의미하는 단어보다는 부정성을 띠는 단어들이 높은 것으로 확인되었음.
